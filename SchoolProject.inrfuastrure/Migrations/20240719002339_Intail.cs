...
namespace SchoolProject.inrfuastrure.Migrations
{
    /// <inheritdoc />
    public partial class Intail : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_studentsSubject", x => x.StudSubID);
                    table.ForeignKey(
                        name: "FK_studentsSubject_students_StudID",
                        column: x => x.StudID,
                        principalTable: "students",
                        principalColumn: "StudID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_studentsSubject_subjects_SubID",
                        column: x => x.SubID,
                        principalTable: "subjects",
                        principalColumn: "SubID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_studentsSubject_StudID",
                table: "studentsSubject",
                column: "StudID");

            migrationBuilder.CreateIndex(
                name: "IX_studentsSubject_SubID",
                table: "studentsSubject",
                column: "SubID");
        }
